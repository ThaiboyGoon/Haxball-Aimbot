var avatarIndex = 0, tempA, ballPos, currentPlayerPos, playerPoss = [], keyObj, endBallPos, lastEndKonum = null, kontrolSayac = 0, timeoutKontrol;
var aimEnabled = true, intervalAvatar;
//var token = "thr1.AAAAAF0U1OpYqyZtbeeojQ._n3PO7s6C5Q";

var strikerPos, aimPos;
...
function collisionCircleCircle(p1, p2, r) {
var d1 = p1.x - p2.x;
var d2 = p1.y - p2.y;
...
for (var f =
e.get("title"), e = e.get("buttons"), g = 0, l = 0; l < c.length;) {
var k = c[l++],
...
null == P.ug && (P.ug = window.document.createElement("div"), c.He.appendChild(P.ug), P.xq = d.render(P.ug, {
sitekey: a,
callback: function(a) {
y.i(P.Bl, a)
},
...
for (var a = [], b = 0, c = this.Si; b < c;) ++b, a.push(0);
this.Xp = a;
...
if (null != a.ib) {
var b = a.ib.Cm;
null != b && (a.ib.Ja.remove(), a.ib = null, b(), a.Ig())
}
};
...
b = l instanceof p ? l.Ta :
l, b instanceof SyntaxError ? y.i(a.ci, "SyntaxError in line: " + K.xe(b.lineNumber)) : b instanceof Bb ? y.i(a.ci, b.pp) : y.i(a.ci, "Error loading stadium file.")
}
};
c.readAsText(b)
}
...
c.textContent = "" + a++, this.Yh.appendChild(c);
...
break;
case 27:
b.Bc.Lb.hidden ? (b.fb.value = "", b.fb.blur()) : b.Bc.Nh();
break;
case 38:
b.Bc.Mj(-1);
break;
...
this.Bq = new R(["Red is", "Victorious!"],
15035990);
...
function R(a, b) {
for (var c = [], d = 0; d < a.length;) c.push(this.kp(a[d++], b));
this.Ve = c
}
...
if (1212305970 != a.gb()) throw new p("");
b = a.gb();
if (c != b) throw new p(new Kb(b));
this.lf = a.gb();
...
a = window.setTimeout(c, a + 1E3), b.rm = a)
};
c();
...
for (b = 0; b < c.length;) this.Wn(c[b++]);
this.Z = a
}
...
ks: function() {
if (null == this.r.nc) throw new p("No string matched");
return {
jj: this.r.nc.index,
...
if (b = null != this.r.nc) this.r.Zg = a;
return b
}
if (c =
this.match(0 > c ? D.substr(a, b, null) : D.substr(a, b, c))) this.r.Zg = a, this.r.nc.index += b;
return c
},
f: gc
};
...
d;
for (d in a) "__id__" != d && "hx__closures__" !=
d && c.call(a, d) && b.push(d)
}
return b
};
K.b = !0;
...
J.Bs = function(a) {
for (var b = a.length, c = 0; c < b && J.fs(a, b - c - 1);) ++c;
...
U.Ur = function(a) {
for (var b = "", c = 0, d = a.byteLength; c < d;) b += J.Sg(a[c++], 2);
return b
};
ec.b = !0;
ec.prototype = {
...
null != this.pa && (this.pa.ja(), this.pa = null)
},
Ne: function(a) {
...
switch (b) {
case 1:
for (var b = a.ic(), c = a.tg(), d = [], e = 0; e < c.length;) d.push(new RTCIceCandidate(c[e++]));
this.Lh(b, d, a);
break;
case 4:
...
for (var a = 0; a < b.length;) c.pa.Qa.addIceCandidate(b[a++])
}, function() {
c.Ne(Pb.Error)
})
},
...
for (var g = 0; g < b.length;) d.uj(b[g++]);
...
null == a && (a = "");
var d = this;
N.fq(this.sr, "token=" + this.Ag +
"&rcr=" + a, N.cn).then(function(a) {
switch (a.action) {
case "connect":
c(a);
break;
...
d = 0 != a.B();
e = a.ic();
for (var g = a.tg(), l = [], k = 0; k < g.length;) l.push(new RTCIceCandidate(g[k++]));
f = l
} catch (t) {
this.qf(b, 0);
return
...
var g = this;
if (16 <= this.od.size) this.qf(a, 4104);
else if (this.ph.has(b)) this.qf(a, 4102);
else {
...
c;
try {
a = new F(new DataView(pako.inflateRaw(a.rb()).buffer), !1), c = new RTCIceCandidate(a.tg())
} catch (d) {
return
}
this.Eo(b, c)
...
if (null != c) {
var d = Sa.rk(b);
if (null != d && (c.me.push(d), this.Hf.has(d))) return;
c.uj(b)
}
},
Fo: function(a) {
...
sn: function(a) {
for (var b = 0, c = a.me; b < c.length;) this.Hf.add(c[b++]);
...
else if (252 == (c & 254)) d = a.getUint8(b + 1), e = a.getUint8(b + 2), f = a.getUint8(b +
3), g = a.getUint8(b + 4), l = a.getUint8(b + 5), c = (c & 1) << 30 | (d & 63) << 24 | (e & 63) << 18 | (f & 63) << 12 | (g & 63) << 6 | l & 63, b += 6;
else throw new p("Cannot decode UTF8 character at offset " + b + ": charCode (" + c + ") is invalid");
return {
"char": c,
length: b - k
}
...
if (this.a + a > this.o.byteLength) throw new p("Read too much");
...
u: function() {
var a = this.o.getFloat64(this.a,
this.Ra);
this.a += 8;
return a
},
...
var b = this.a,
c, d = "";
for (a = b + a; b < a;) c = F.ao(this.o, b), b += c.length, d += String.fromCodePoint(c["char"]);
if (b != a) throw new p("Actual string length differs from the specified: " + (b - a) + " bytes");
this.a = b;
return d
},
yb: function() {
...
w.mo = function(a, b, c) {
var d = c;
if (0 > a) throw new p("Cannot encode UTF8 character: charCode (" + a + ") is negative");
...
else if (2097152 > a) b.setUint8(c,
a >> 18 & 7 | 240), b.setUint8(c + 1, a >> 12 & 63 | 128), b.setUint8(c + 2, a >> 6 & 63 | 128), b.setUint8(c + 3, a & 63 | 128), c += 4;
...
else throw new p("Cannot encode UTF8 character: charCode (" +
a + ") is too large (>= 0x80000000)");
return c - d
};
w.xn = function(a) {
if (0 > a) throw new p("Cannot calculate length of UTF8 character: charCode (" + a + ") is negative");
if (128 > a) return 1;
if (2048 > a) return 2;
if (65536 > a) return 3;
...
w.Jf = function(a) {
for (var b = 0, c = a.length, d = 0; d < c;) b += w.xn(D.Zi(a, d++));
return b
};
w.yn = function(a) {
a >>>= 0;
return 128 >
a ? 1 : 16384 > a ? 2 : 2097152 > a ? 3 : 268435456 > a ? 4 : 5
};
w.prototype = {
Hg: function() {
...
Tq: function(a) {
if (1 >
a) throw new p("Can't resize buffer to a capacity lower than 1");
...
Cb: function(a) {
null ==
a ? this.kb(0) : (this.kb(w.Jf(a) + 1), this.Lg(a))
},
zm: function(a) {
var b = w.Jf(a);
if (255 < b) throw new p(null);
this.l(b);
this.Lg(a)
},
Kg: function(a) {
...
var b = this.a;
this.rc(b + w.Jf(a));
for (var c = a.length, d = 0; d < c;) b += w.mo(D.Zi(a, d++), this.o, b);
this.a = b
},
kb: function(a) {
var b = this.a;
...
128 <= a ? (this.o.setUint8(b + 1, a >> 7 | 128), 16384 <= a ? (this.o.setUint8(b + 2, a >> 14 | 128), 2097152 <= a ? (this.o.setUint8(b + 3, a >> 21 | 128), 268435456 <= a ? (this.o.setUint8(b +
4, a >> 28 & 127), a = 5) : (this.o.setUint8(b + 3, this.o.getUint8(b + 3) & 127), a = 4)) : (this.o.setUint8(b + 2, this.o.getUint8(b + 2) & 127), a = 3)) : (this.o.setUint8(b + 1, this.o.getUint8(b + 1) & 127), a = 2)) : (this.o.setUint8(b, this.o.getUint8(b) & 127), a = 1);
this.a += a
},
f: w
};
...
for (var c =
0, t = k.byteLength; c < t;) {
var h = c++;
if (k[h] != b[h]) return Promise.reject(null)
}
return I.Rr(g, l).then(function(a) {
return window.crypto.subtle.verify(I.dm, a, e, d)
}).then(function(a) {
if (!a) throw new p(null);
return g
})
} catch (jc) {
...
m.Ha = function(a) {
a.gn = m.wf;
if (null == a.za) throw new p("Class doesn't have a config");
a.prototype.xf = a.za;
m.Hm.set(m.wf, a);
m.wf++
};
...
var c = (null ==
a ? null : r.Em(a)).gn;
if (null == c) throw new p("Tried to pack unregistered action");
b.l(c);
a.ua(b)
};
m.bh = function(a) {
...
xs: function(a) {
for (var b = 0, c = 0, d = this.list; c < d.length && !(d[c++].lb >= a);) ++b;
this.list.splice(0,
b)
},
Wr: function(a, b) {
...
b.index = 0;
this.Pd += b.weight;
for (a = 0; a < this.Ya.length && this.Ya[a].value <= b.value;) ++a;
this.Ya.splice(a, 0, b)
},
Xg: function(a) {
if (0 == this.Ya.length) return 0;
if (1 == this.Ya.length) return this.Ya[0].value;
a *= this.Pd;
for (var b = this.Ya[0].weight, c = 0; c < this.Ya.length - 1 && !(b >= a);) ++c, b += this.Ya[c].weight;
...
for (; c < d;) {
a = b[c];
if (a.lb != this.X || a.ba != this.cc) break;
a.apply(this.T);
...
for (d = this.Oi.list; 0 < d.length;) d.pop();
return c
},
fr: function(a) {
300 < a && (a = 300);
...
window.clearTimeout(this.pe);
null != this.pa && (this.pa.bf = null, this.pa.ja(), this.pa = null);
...
this.Ac + this.Ni.Xg(.5) - this.X;
this.Kj()
},
Qf: function() {
return this.wd() ? (0 > this.bc && (this.bc = 0), this.sk(window.performance.now() * this.Ac + this.Ni.Xg(.5) - this.X + this.bc + this.rd, this.rg)) : this.T
},
Kj: function() {
0 > this.Vc && (this.Vc = 0);
...
this.cc = a.zb();
this.Vc = 10;
for (this.T.ka(a); 0 < a.o.byteLength - a.a;) this.zg(this.xm(a));
window.clearTimeout(this.pe);
this.rf(3)
},
dr: function(a) {
...
++a;
c.frame <=
this.X || c.wf == this.se + this.cc + this.je.Xr(c.frame) && this.on(c.frame - this.X)
}
...
m.ij(a, d);
this.Rb(d);
a.xf.Ba && (a.te = b, a.P = this.uc, a.lb =
c, this.rg.Im(a))
}
},
f: xa
...
Go: function(a, b) {
if (this.ac.length >= this.dg) return hc.gh(4100);
try {
if (b.Ob() != this.Nr) throw new p(null);
} catch (d) {
return hc.gh(4103)
}
try {
var c =
b.yb();
if (null != this.Hb && c != this.Hb) throw new p(null);
} catch (d) {
return hc.gh(4101)
}
return hc.Zm
...
Dp: function(a) {
var b = this;
if (this.ac.length >= this.dg) a.ja();
else {
var c = new ac(a);
this.ac.push(c);
a.jg = function(a) {
...
c.kb(this.cc);
this.T.ea(c);
for (var d = this.je.list, e = 0, f = d.length; e < f;) this.el(d[e++], c);
...
default:
throw new p(0);
} else if (0 == c) this.rq(a, b);
else throw new p(0);
if (0 < a.o.byteLength - a.a) throw new p(2);
} catch (d) {
...
e.P = b.Z;
e.lb = c < f ? f : c > g ? g : c;
e.Rm(this.T) && (this.zg(e), this.Bg(this.Wh(e), 1))
},
f: Lb
});
ac.b = !0;
...
var a =
this.Kc;
0 < a.o.byteLength - a.a ? (a = this.Kc.zb(), this.fg += a, a = this.Kc.Ob(), this.eg = m.bh(this.Kc), this.eg.P = a) : this.eg = null
},
yo: function() {
...
b = a - this.Th;
this.Th = a;
0 < this.Fd ? (this.Qb += 1E4, this.Qb > this.Fd && (this.Qb = this.Fd, this.Fd = -1)) : this.Qb += b * this.ll;
a = this.lf * this.ih;
this.Qb > a && (this.Qb = a);
b = this.Qb * this.Ac;
a = b | 0;
...
for (; null !=
this.eg && this.fg == this.X;) b = this.eg, b.apply(this.T), null != this.fc && this.fc(b), this.yl();
this.X++;
this.T.C(1)
}
},
...
vb.b = !0;
vb.Vp = function(a) {
if (3 > a.length) throw new p("Not enough arguments");
if (7 < a.length) throw new p("Too many arguments");
var b = new Pa,
c = new ka;
b.Pg = c;
switch (a[1]) {
...
if (4 < a.length) {
c.eb = [];
for (var d = 4, e = a.length; d < e;) c.eb.push(K.parseInt("0x" + a[d++]))
}
return b
};
vb.prototype = {
...
let ems = ["ðŸ˜€", "ðŸ˜", "ðŸ˜‚", "ðŸ¤£", "ðŸ˜ƒ", "ðŸ˜„", "ðŸ˜…", "ðŸ˜†", "ðŸ˜‰", "ðŸ˜Š", "ðŸ˜‹", "ðŸ˜Ž", "ðŸ˜", "ðŸ˜˜", "ðŸ˜—", "ðŸ˜™", "ðŸ˜š", "â˜ºï¸", "ðŸ™‚", "ðŸ¤—", "ðŸ¤©", "ðŸ¤”", "ðŸ¤¨", "ðŸ˜", "ðŸ˜‘", "ðŸ˜¶", "ðŸ™„", "ðŸ˜", "ðŸ˜£", "ðŸ˜¥", "ðŸ˜®", "ðŸ¤", "ðŸ˜¯", "ðŸ˜ª", "ðŸ˜«", "ðŸ˜´", "ðŸ˜Œ", "ðŸ˜›", "ðŸ˜œ", "ðŸ˜", "ðŸ¤¤", "ðŸ˜’", "ðŸ˜“", "ðŸ˜”", "ðŸ˜•", "ðŸ™ƒ", "ðŸ¤‘", "ðŸ˜²", "â˜¹ï¸", "ðŸ™", "ðŸ˜–", "ðŸ˜ž", "ðŸ˜Ÿ", "ðŸ˜¤", "ðŸ˜¢", "ðŸ˜­", "ðŸ˜¦", "ðŸ˜§", "ðŸ˜¨", "ðŸ˜©", "ðŸ¤¯", "ðŸ˜¬", "ðŸ˜°", "ðŸ˜±", "ðŸ˜³", "ðŸ¤ª", "ðŸ˜µ", "ðŸ˜¡", "ðŸ˜ ", "ðŸ¤¬", "ðŸ˜·", "ðŸ¤’", "ðŸ¤•", "ðŸ¤¢", "ðŸ¤®", "ðŸ¤§", "ðŸ˜‡"];
//let ems = ["0", "1"];

if (avatarIndex == ems.length)
avatarIndex = 0;

t.Yl(ems[avatarIndex++]);
}, 100);
}
break;
case "avatar1":
{
if(typeof Hax1 === "undefined") {Hax1 = 0; }
if(typeof Hax2 === "undefined") {Hax2 = 0; }
if(Hax1 !== 0)
{
clearInterval(Hax1);
Hax1 = 0;
...
var patatesIki = 0;
var patates = "";
var patatesInterval = 0;

if(a.length != 2) { patatesInterval = 1000; }
else { patatesInterval = a[1]; }
Hax1 = setInterval(function()
{
patatesIki++;
if(patatesIki > 9)
{
...
patates = patatesBir.toString() + patatesIki.toString();
self.Yl(patates);
...
if(a.length != 5)
{
this.ha("Invalid Parameter passed avatar2!");
this.ha("/avatar2 <Time> <1> <2> <3> !");
}
else
{
var self = this;
var patatesIntervall = a[1];
var patabir = a[2];
var pataiki = a[3];
var patauc = a[4];
var pataindeks = 1;
Hax2 = setInterval(function()
{
if(pataindeks == 1)
{
self.Yl(patabir);
...
this.ya.T.S;
a = d.w;
d.Oe() ? this.ha('Current stadium is original: "' + a + '"') : (d = J.Sg(d.Oj(), 8), this.ha('Stadium: "' + a + '" (checksum: ' + d + ")"));
break;
case "clear_avatar":
...
break;
case "clear_password":
null == this.Cg ? this.ha("Only the host can change the password") : (this.Cg(null), this.ha("Password cleared"));
break;
case "colors":
try {
d = vb.Vp(a),
...
break;
case "handicap":
2 == a.length ? (a = K.parseInt(a[1]), null != a && 0 <= a && 300 >= a ? (this.ya.fr(a), this.ha("Ping handicap set to " + a + " msec")) :
this.ha("Ping handicap must be a value between 0 and 300 milliseconds")) : this.ha("Ping handicap requires a value in milliseconds.");
break;
case "kick_ratelimit":
...
break;
case "set_password":
2 == a.length && (null == this.Cg ? this.ha("Only the host can change the password") : (this.Cg(a[1]), this.ha("Password set")));
break;
case "store":
var e = this.ya.T.S;
...
ca.Sl = function(a) {
var b = new Date;
Da.Wq(a, "HBReplay-" + b.getFullYear() + "-" + J.yf("" + (b.getMonth() + 1)) + "-" + J.yf("" + b.getDate()) + "-" + J.yf("" +
b.getHours()) + "h" + J.yf("" + b.getMinutes()) + "m.hbr2")
};
ca.uq = function(a) {
...
Jc: function() {
var a = window.performance.now();
1 == n.A.Ch.L() && 28.333333333333336 > a - this.Yc || (this.Yc = a, this.sd++, this.sf(), a = this.ya.T.na(this.ya.uc), null != a && (this.vi = a.bb), this.j.C(this.ya))
},
yp: function(a) {
var b = this;
...
c = b.Db;
c.wg = n.A.Ml.L();
0 == a ? (b.Dg(!0), c.jf = 1, c.hf = 0, c.vf = 0) : (b.Dg(!1), c.vf = 35, -1 == a ? c.hf = 450 : (c.hf = 0, c.jf = 1 + .25 * (a - 1)))
},
Cd: function(a) {
this.nb.Cd(a.code)
},
...
var a =
n.A.Cj.L();
if (null == a) I.qo().then(function(a) {
v.Ie = a;
n.A.Cj.Wa(a.Dr())
})["catch"](function() {
return {}
});
else I.po(a).then(function(a) {
return v.Ie = a
})["catch"](function() {
return {}
})
...
} else b.vd.Hb ? v.Ah(b.Z) : v.Nf(b.Z)
};
a.rs = function() {
v.fo()
};
...
k.zp = function(a, b) {
var d = b.ic();
if (25 < d.length) throw new p("name too long");
var e = b.ic();
if (3 < e.length) throw new p("country too long");
var f = b.yb();
if (null != f && 2 < f.length) throw new p("avatar too long");
d = oa.la(a, d, e, f);
k.ra(d);
c()
};
...
if (c instanceof Kb) a = new W("Incompatible replay version",
"The replay file is of a different version", ["Open player", "Cancel"]), x.Sa(a.g), a.$a = function(a) {
...
window.console.log(Q instanceof p ? Q.Ta : Q), c = new W("Unexpected Error", "",
[]), c.He.innerHTML = "An error ocurred while attempting to join the room.<br><br>This might be caused by a browser extension, try disabling all extensions and refreshing the site.<br><br>The error has been printed to the inspector console.", x.Sa(c.g)
}
};
x.b = !0;
x.es = function() {
...
0 != d.length ? (window.document.body.innerHTML = "", x.Mg = window.document.createElement("div"), window.document.body.appendChild(x.Mg),
a = new Wa(d), x.Sa(a.g)) : a()
};
x.ps = function(a) {
...
null != a && (x.Mg.appendChild(a), x.Mm = a)
};
Wb.b = !0;
Wb.prototype = {
ja: function() {
...
this.he.C();
var a = window.performance.now();
1 == n.A.Ch.L() && 28.333333333333336 > a - this.Yc || (this.Yc = a, this.sd++, this.sf(n.A.Tb.L()), 0 < this.ya.Fd || this.j.C(this.ya))
},
Bd: function(a) {
switch (a.keyCode) {
case 27:
...
sf: function(a) {
var b = this.j.Eb;
0 >= a ? (b.Dg(!0), b.Db.jf = 1, b.Db.vf = 0) : (b.Dg(!1), b.Db.vf = 35, b.Db.jf = 1 + .25 * (a - 1))
},
Cd: function() {},
f: Wb
};
...
this.I = a.B();
a.Ra = !1;
if (30 < this.I || 30 < this.We) throw new p(null);
this.Lj()
},
f: Fb
};
...
aa.add = function(a) {
return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function(b, c) {
var d = window.indexedDB.open("stadiums",
1);
d.onblocked = d.onerror = c;
d.onupgradeneeded = function(a) {
var b = d.result;
...
0 >= this.$g && .05 > this.ue && (window.clearInterval(this.dh), this.dh = null, this.ue = 0);
...
v = v * v + r * r;
if (p.ca == q.da) {
if (null == d || d.a.x * m < p.H.a.x * m) d = p.H;
if (null ==
e || e.a.x * m > p.H.a.x * m) e = p.H;
if (null == f || v < g) f = p.H, g = v
} else if (p.ca == q.xa) {
if (null == l || l.a.x * m < p.H.a.x * m) l = p.H;
if (null == k || k.a.x * m > p.H.a.x * m) k = p.H;
if (null == t || v < h) t = p.H, h = v
}
}
}
null != k && null != e && 0 >= b.Na && (f.a.x > k.a.x && c.a.x > k.a.x && 20 < c.a.x && this.nj(.3), t.a.x < e.a.x && c.a.x < e.a.x && -20 > c.a.x && this.nj(.3))
}
},
f: Ub
};
...
a = 0;
for (var b = this.S.F; a < b.length;) this.ta.F.push(b[a++].jp());
this.Ck()
},
yk: function(a) {
if (a.ca == q.Ia) a.H = null;
else {
a.nb = 0;
var b = a.H;
...
0 == d.length ? (b.a.x = a.ca.zh * this.S.$b, b.a.y = 0) : (a = b.a, d = d[d.length - 1], a.x = d.x, a.y = d.y);
d = b.D;
d.x = 0;
d.y = 0;
b = b.oa;
...
C: function(a) {
if (0 < this.Na) 120 > this.Na && this.Na--;
else {
var b = this.Ka.Js;
null != b && b();
...
this.ta.F;
e = 0;
for (g = d.length; e < g;) f = e++, l = d[f], 0 != (l.v & 128) && (O.$j[c] = f, f = O.Uk[c], l = l.a, f.x = l.x, f.y = l.y, ++c);
this.ta.C(a);
if (0 == this.Ab) {
for (a = 0; a < b.length;) c = b[a], ++a, null != c.H && (c.H.h = 39 | this.Zd.Vo);
b = this.ta.F[0].D;
...
d != q.Ia ? (this.Ab = 2, this.vc = 150, this.Zd = d, d == q.da ? this.Jb++ : this.Pb++,
null != this.Ka.Ki && this.Ka.Ki(d.ng), null != this.Ka.Jl && this.Ka.Jl(d.Z)) : 0 < this.Da && this.Hc >= 60 * this.Da && this.Pb != this.Jb && (null != this.Ka.Mi && this.Ka.Mi(), this.lm())
} else if (2 == this.Ab) this.vc--, 0 >= this.vc && (0 < this.hb && (this.Pb >= this.hb || this.Jb >= this.hb) || 0 < this.Da && this.Hc >= 60 * this.Da && this.Pb != this.Jb ? this.lm() : (this.Ck(), null != this.Ka.cq && this.Ka.cq()));
else if (3 == this.Ab && (this.vc--, 0 >= this.vc && (b = this.Ka, null != b.K))) {
b.K = null;
a = 0;
for (c = b.I; a < c.length;) d = c[a], ++a, d.H = null, d.Ib = 0;
null != b.tf && b.tf(null)
}
}
},
...
l = b[e.Z],
k = e == q.da ? g.Dd : g.md;
0 == k.length ? (k = l + 1 >> 1, 0 == (l & 1) && (k = -k), g = g.kc * e.zh, l = 55 * k) : (l >= k.length && (l = k.length - 1), l = k[l], g = l.x, l = l.y);
f.x = g;
f.y = l;
b[e.Z]++;
d.Ib = b[e.Z]
...
h.ka = function(a) {
var b = a.B();
return 255 == b ? (b = new h, b.Fr(a), b) : h.Hh()[b]
};
h.Hh = function() {
if (null == h.vb) {
h.vb = [];
...
if ("string" == typeof a) return K.parseInt("0x" + K.xe(a));
if (a instanceof Array && null == a.mb) return ((a[0] | 0) << 16) + ((a[1] | 0) << 8) + (a[2] | 0);
...
g = a.strength,
l = a.length;
if (d >= b.length || 0 > d) throw new p(null);
if (e >= b.length || 0 > e) throw new p(null);
c.Wd = d;
c.Xd = e;
null == l ? (d = b[d], l = b[e], null == d || null == l ? c.ec = c.Gb =
100 : (e = d.a, l = l.a, d = e.x - l.x, e = e.y - l.y, c.ec = c.Gb = Math.sqrt(d * d + e * e))) : l instanceof Array && null == l.mb ? (c.Gb = r.G(l[0], z), c.ec = r.G(l[1], z)) : c.ec = c.Gb = r.G(l, z);
...
a.l(this.U.length);
b = 0;
for (c = this.U; b < c.length;) c[b++].ea(a);
a.l(this.qa.length);
b = 0;
for (c = this.qa; b < c.length;) c[b++].ea(a);
a.l(this.tc.length);
b = 0;
for (c = this.tc; b < c.length;) c[b++].ea(a);
a.l(this.F.length);
b = 0;
for (c = this.F; b < c.length;) c[b++].ea(a);
a.l(this.ob.length);
b = 0;
for (c = this.ob; b < c.length;) c[b++].ea(a);
a.l(this.Dd.length);
b = 0;
for (c = this.Dd; b < c.length;) d = c[b], ++b, a.s(d.x), a.s(d.y);
a.l(this.md.length);
b = 0;
for (c = this.md; b < c.length;) d =
c[b], ++b, a.s(d.x), a.s(d.y)
}
},
Fr: function(a) {
function b() {
...
this.U = [];
c = a.B();
for (d = 0; d < c;) ++d, e = new E,
e.ka(a, this.J), this.U.push(e);
this.qa = [];
c = a.B();
for (d = 0; d < c;) ++d, e = new L, e.ka(a), this.qa.push(e);
this.tc = [];
c = a.B();
for (d = 0; d < c;) ++d, e = new tb, e.ka(a), this.tc.push(e);
this.F = [];
c = a.B();
for (d = 0; d < c;) ++d, e = new ua, e.ka(a), this.F.push(e);
this.ob = [];
c = a.B();
for (d = 0; d < c;) ++d, e = new ob, e.ka(a), this.ob.push(e);
this.Dd = b();
this.md = b();
this.fe()
},
fe: function() {
for (var a = 0, b = this.U; a < b.length;) b[a++].fe()
},
Oe: function() {
return 255 != this.yh
},
...
b = [];
e = 0;
for (f = this.U; e < f.length;) b.push(h.ar(f[e++], d));
d = [];
e = 0;
for (f = this.qa; e < f.length;) d.push(h.Yp(f[e++]));
for (var e = [], f = 0, g = this.tc; f < g.length;) e.push(h.Bo(g[f++]));
for (var f = h.aq(this.ee), l = new ua, g = [], k = 0, t = this.F; k < t.length;) g.push(h.eo(t[k++], l));
l = [];
k = 0;
for (t = this.ob; k <
t.length;) l.push(h.To(t[k++]));
...
if (255 < this.J.length || 255 < this.U.length || 255 < this.qa.length || 255 < this.tc.length || 255 < this.F.length) throw new p("Error");
this.fe()
},
Oj: function() {
var a = h.Ar;
...
this.J.push(n);
l = b;
for (b = this.J.length; l < b;) k = l++, this.J[k].h = f, this.J[k].v = g, this.J[k].m = .1;
b = this.U.length;
this.U.push(h);
this.U.push(p);
this.U.push(q);
l = b;
for (b = this.U.length; l < b;) k = l++, this.U[k].h = f, this.U[k].v = g, this.U[k].m = .1;
f = new ua;
g = f.a;
g.x = a;
g.y = -c;
...
a.l(this.eb.length);
for (var b =
0, c = this.eb; b < c.length;) a.O(c[b++])
},
ka: function(a) {
this.hd = a.B();
this.dd = a.M();
var b = a.B();
if (3 < b) throw new p("too many");
this.eb = [];
for (var c = 0; c < b;) ++c, this.eb.push(a.M())
},
f: ka
};
q.b = !0;
...
var b = 0 != a.B();
this.K = null;
b && (this.K = new O, this.K.ka(a, this));
...
b = w.ga();
this.ea(b);
for (b = b.Br(); 4 <= b.o.byteLength - b.a;) a ^= b.M();
return a
},
so: function() {
var a = w.ga(4);
...
apply: function(a) {
var b = a.na(this.P);
null != b && this.Vg != b.Kd && (b.Kd = this.Vg, y.i(a.ol, b))
},
ua: function(a) {
a.l(this.Vg ? 1 : 0)
},
...
apply: function(a) {
0 ==
this.P && wb.i(a.Pl, this.Rc, this.color, this.style, this.Xm)
},
ua: function(a) {
...
va: function(a) {
this.Rc = a.ic();
if (1E3 < this.Rc.length) throw new p("message too long");
this.color = a.M();
this.style = a.B();
this.Xm = a.B()
},
...
apply: function(a) {
if (a.Kb(this.P, 2) && null == a.K) switch (this.oj) {
case 0:
var b = this.newValue;
...
var b = a.na(this.P),
c = a.na(this.Ld);
null != c && 0 != c.V && c.bb != this.Ug && (c.bb = this.Ug, null != a.gi && a.gi(b, c))
}
},
ua: function(a) {
a.O(this.Ld);
...
va: function(a) {
this.Rc = a.ic();
if (140 < this.Rc.length) throw new p("message too long");
},
f: Na
});
Ha.b = !0;
...
var b = a.na(this.V);
null != b && (D.remove(a.I,
b), null != a.K && D.remove(a.K.ta.F, b.H), wb.i(a.ql, b, this.fd, this.Ng, a.na(this.P)))
}
},
ua: function(a) {
...
this.fd = a.yb();
this.Ng = 0 != a.B();
if (null != this.fd && 100 < this.fd.length) throw new p("string too long");
},
f: Z
});
qb.b = !0;
...
a.l(this.Qm ? 1 : 0);
a.l(this.Wg.length);
for (var b = 0, c = this.Wg; b < c.length;) a.O(c[b++])
},
va: function(a) {
this.Qm = 0 != a.B();
var b = a.B();
this.Wg = [];
for (var c = 0; c < b;) ++c, this.Wg.push(a.M())
},
f: qb
});
pb.b = !0;
...
a) return;
a = a.H
} else a = b.ta.F[this.ye];
null != a && (null != this.La[0] && (a.a.x = this.La[0]), null != this.La[1] && (a.a.y = this.La[1]), null != this.La[2] && (a.D.x = this.La[2]), null != this.La[3] && (a.D.y = this.La[3]), null != this.La[4] && (a.oa.x = this.La[4]), null != this.La[5] && (a.oa.y = this.La[5]), null != this.La[6] && (a.Y = this.La[6]), null != this.La[7] && (a.m = this.La[7]), null != this.La[8] && (a.$ = this.La[8]), null != this.La[9] && (a.Ca = this.La[9]), null != this.ed[0] && (a.R = this.ed[0]), null != this.ed[1] && (a.h = this.ed[1]), null != this.ed[2] &&
(a.v = this.ed[2]))
}
}
},
...
e = 0;
for (f = this.ed; e < f.length;) g = f[e], ++e, null != g && (c |= d, a.O(g)), d <<= 1;
d = a.a;
a.a = b;
a.Ub(c);
a.a = d
...
this.ed = [];
for (c = 0; 3 > c;) d = c++, 0 != (b & 1) && (this.ed[d] = a.M()), b >>>= 1
},
f: pb
});
ma.b = !0;
...
ua: function(a) {
a.kb(this.ve.length);
for (var b = 0, c = this.ve; b < c.length;) a.kb(c[b++])
},
va: function(a) {
this.ve = [];
for (var b = a.zb(), c = 0; c < b;) ++c, this.ve.push(a.zb())
},
f: la
});
da.b = !0;
...
d = a.Eg;
e = a.Fg;
if ((0 < d.x * b + d.y * c && 0 < e.x * b + e.y * c) == 0 >= a.ub) return;
e = Math.sqrt(b * b + c * c);
if (0 == e) return;
d = e - a.Uj;
b /= e;
...
d != d && (d = .5);
var g, l;
if (this.Gb >= this.ec) g = this.Gb, l = 0;
else if (f <= this.Gb) g = this.Gb, l = 1;
else if (f >= this.ec) g = this.ec, l = -1;
else return;
f = g - f;
if (0 == 0 * this.le) d = this.le * f * .5, e *= d, c *= d, l = d = b.D, b = b.$, d.x = l.x + e * b, d.y = l.y + c * b, d = b = a.D, a = a.$, b.x = d.x + -e * a, b.y = d.y + -c * a;
else {
g = f * d;
var k = b.a,
h = b.a;
...
c = this.F[d];
d += 1;
for (e = this.F.length; d < e;) f = this.F[d++], 0 != (f.h & c.v) && 0 != (f.v & c.h) && c.In(f);
if (0 != c.$) {
d = 0;
...
for (e = this.U; d < e.length;) f = e[d], ++d, 0 != (f.h & c.v) && 0 != (f.v & c.h) && c.Jn(f);
d = 0;
...
k = g * k.x + l * k.y;
0 > k && (k *= c.m * f.m + 1,
h = f = c.D, f.x = h.x - g * k, f.y = h.y - l * k)
}
}
}
for (a = 0; 2 > a;)
for (++a, b = 0, c = this.ob; b < c.length;) c[b++].C(this.F)
},
sc: function() {
var a = ya.zc,
b = this.gc;
...
0 >= this.ub && (a = c = this.Eg, c.x = -a.x, c.y = -a.y, a = c = this.Fg, c.x = -a.x, c.y = -a.y)
} else a = this.W.a,
b = this.aa.a, c = a.x - b.x, a = -(a.y - b.y), b = Math.sqrt(a * a + c * c), this.wa = new H(a / b, c / b)
},
f: E
};
B.b = !0;
...
l = e.F;
k = 0;
for (n = e.ob; k < n.length;) this.Hq(n[k++], l);
this.Gq(a, m, h);
this.Iq(a, f);
null != g && this.Kq(g.a);
this.c.lineWidth = 2;
f = 0;
for (g = a.I; f < g.length;) m = g[f], ++f, h = m.H, null != h && this.Gl(h, this.cd.get(m.V));
f = 0;
...
//if(playerPoss.find(x=>x == g.a) == null && g.gc == null){
//console.log(g);
playerPoss.push(g.a);
//}
}
...
var d = a.value;
a = c.next();
if (!b.has(d)) this.cd["delete"](d)
}
},
Hr: function(a, b, c, d) {
var e, f;
if (null != b && 1 == a.S.Ee) f = b.a, e = f.x, f = f.y;
else if (f = a.ta.F[0].a, e = f.x, f = f.y, null != b) {
var g = b.a;
e = .5 * (e + g.x);
f = .5 * (f + g.y);
var h = .5 * c,
...
Qn: function(a, b, c) {
a > 2 * c.$b ? this.cb.x = 0 : this.cb.x + .5 * a > c.$b ? this.cb.x = c.$b - .5 *
a : this.cb.x - .5 * a < -c.$b && (this.cb.x = -c.$b + .5 * a);
...
var b = 0 < a.Na;
this.gr(b);
b && (120 != a.Na && (a = a.Na / 120 * 200, this.c.fillStyle = "white", this.c.fillRect(.5 * -a, 100, a, 20)), this.td.Wp.Oq(this.c))
},
gr: function(a) {
this.zk != a && (this.sa.style.filter =
a ? "grayscale(70%)" : "", this.zk = a)
},
...
var c = a.Sd,
d = a.Rd;
if (1 == a.ld) this.c.save(), this.c.resetTransform(), this.c.fillStyle = M.lc(a.jd), this.c.fillRect(0, 0, this.sa.width, this.sa.height), this.c.restore(), this.c.strokeStyle = "#C7E6BD", this.c.fillStyle = this.Do,
this.Ql(this.c, -c, -d, 2 * c, 2 * d, a.Sc), this.c.save(), this.c.scale(2, 2), this.c.fill(), this.c.restore(), this.c.moveTo(0, -d), this.c.lineTo(0, d), this.c.stroke(), this.c.beginPath(), this.c.arc(0, 0, a.kd, 0, 2 * Math.PI), this.c.stroke();
else if (2 == a.ld) {
...
e("#85ACF3", c, !1);
e("#E18977", -c, !0)
} else this.c.save(), this.c.resetTransform(), this.c.fillStyle = M.lc(a.jd), this.c.fillRect(0, 0, this.sa.width, this.sa.height), this.c.restore();
M.Di(this.c, !0)
},
Iq: function(a, b) {
for (var c =
n.A.wk.L(), d = 0, e = a.I; d < e.length;) {
var f = e[d];
++d;
var g = f.H;
if (null != g) {
...
if (null != a) {
var b = 0;
for (a = a.U; b < a.length;) this.Lq(a[b++])
}
},
Hq: function(a, b) {
if (!(0 > a.R)) {
...
Lq: function(a) {
if (currentPlayerPos && ballPos && aimEnabled) {
let guc = 350;
let wallX = 370; //550; //370; //550 //1164;
let wallY = 170; //240;//170; //240 //550;
let ballR = 10;
let playerR = 15;
let hedefR = 10;

let ang = angle(currentPlayerPos.x, currentPlayerPos.y, ballPos.x, ballPos.y);
...
//birinci Ã§izgi bulunuyor
while ((guc - gucIndex) >= 0.05) {
gucIndex++;
let distXIndex = ballPos.x + Math.cos(ang) * gucIndex;
let distYIndex = ballPos.y + Math.sin(ang) * gucIndex;

let durdur = false;

if (playerPoss.find(o => collisionCircleCircle({ x: distXIndex, y: distYIndex }, { x: o.x, y: o.y }, playerR + hedefR))) {
guc = 0;
durdur = true;
}
else {
...
let distXIndex = noktalar[cizgiIndex].x + distXk * Math.cos(ang) * gucIndex2;
let distYIndex = noktalar[cizgiIndex].y + distYk * Math.sin(ang) * gucIndex2;
...
this.c.beginPath();
this.c.moveTo(ballPos.x, ballPos.y);

for (let index = 0; index < noktalar.length; index++) {
let nokta = noktalar[index];

this.c.strokeStyle = "green";
this.c.globalAlpha = 0.3;
this.c.lineTo(nokta.x, nokta.y);
this.c.stroke();

this.c.beginPath();
this.c.strokeStyle = "red";
this.c.globalAlpha = 0.4;
this.c.arc(nokta.x, nokta.y, hedefR, 0, 2 * Math.PI, !1);
this.c.stroke();
}
//let distX = Math.cos(ang) * gucIndex;
//let distY = Math.sin(ang) * gucIndex;

//this.c.lineTo(ballPos.x + distX, ballPos.y + distY);
//this.c.moveTo(ballPos.x + distX, ballPos.y + distY);

////this.c.arc(ballPos.x + distX, ballPos.y + distY, hedefR, 0, 2 * Math.PI, !1);

//this.c.stroke();

//let distX2 = Math.cos(ang) * (guc - gucIndex);
//let distY2 = Math.sin(ang) * (guc - gucIndex);

//// this.c.moveTo(ballPos.x, ballPos.y);
//this.c.lineTo(ballPos.x + distX + distXk * distX2, ballPos.y + distY + distYk * distY2);

////this.c.arc(distX + distX2, distY + distY2, hedefR, 0, 2 * Math.PI, !1);
//this.c.stroke();
}
...
var b = a.W.a,
c = a.aa.a;
if (0 != 0 * a.ub) this.c.moveTo(b.x, b.y), this.c.lineTo(c.x,
c.y);
else {
a = a.Vd;
var d = b.x - a.x,
...
f = a.x - c;
a = a.y - d;
900 < f * f + a * a && (this.c.fillStyle = "rgba(0,0,0,0.5)", this.kk(c +
2, d + 2, Math.atan2(a, f)), this.c.fillStyle = M.lc(b), this.kk(c - 2, d - 2, Math.atan2(a, f)))
},
kk: function(a, b, c) {
this.c.save();
...
Fa.b = !0;
Fa.En = function(a, b) {
if (a.hd != b.hd || a.dd != b.dd) return !1;
var c = a.eb,
d = b.eb;
...
e = n.A.cm.L() && null != d;
if (!Fa.En(this.jb,
c) || !e && a.Ib != this.qh || e && this.If != d) Fa.Un(this.jb, c), e ? (this.If = d, this.qh = -1) : (this.If = "" + a.Ib, this.qh = a.Ib), this.Cq(this.If)
}
...
for (var c = -32, d = 64 / b.length, e = 0; e < b.length;) this.qb.fillStyle = M.lc(b[e++]), this.qb.fillRect(c, -32, d + 4, 64), c += d;
this.qb.restore();
...
h[0].className = "elem";
h[0].innerHTML = '<div class="flagico f-' +
e + '"></div> ' + g;
a.appendChild(h[0]);
...
for (a = b ? 50 : 100; this.dc.childElementCount >
a;) this.dc.firstElementChild.remove();
this.sg.update()
},
ha: function(a, b) {
...
a = this.Uc[this.wc];
b != this.wc &&
(a.Ja.classList.toggle("selected", !0), this.Uc[b].Ja.classList.toggle("selected", !1));
a = a.Ja;
b = a.offsetTop;
a = b + a.offsetHeight;
...
io: function() {
null != this.Uc && (this.hk(this.Uc[this.wc].item), this.Nh())
},
f: mb
};
lb.b = !0;
...
C: function(a) {
var b = a.K;
null != b && (this.xc.or(60 * a.Da), this.xc.nr(b.Hc | 0), this.Jb.set(b.Jb), this.Pb.set(b.Pb),
...
Fl: function() {
this.pr(this.Je < this.Da && this.Je >
this.Da - 30)
},
kr: function(a) {
...
ke: function(a) {
this.Gd != a && ((this.Gd = a) ? (this.Gh.appendChild(this.Va.g), this.Eb.g.remove()) : (this.Gh.appendChild(this.Eb.g),
this.Va.g.remove()))
},
Ro: function() {
return null != ja.bq
...
C: function(a, b) {
this.g.draggable = b;
this.xb != a.xb && (this.xb = a.xb, this.og.textContent =
"" + this.xb);
...
for (c = 0; c < a.length;) f = a[c], ++c, g = this.xd.get(f.V), null == g && (g = new cb(f), g.ef = function(a) {
y.i(e.ef, a)
}, this.xd.set(f.V, g), this.Za.appendChild(g.g)), g.C(f, d), b["delete"](f.V);
d = b.values();
for (b =
d.next(); !b.done;) c = b.value, b = d.next(), this.xd.get(c).g.remove(), this.xd["delete"](c);
d = 0;
for (b = a.length - 1; d < b;) f = d++, c = this.xd.get(a[f].V).g, f = this.xd.get(a[f + 1].V).g, c.nextSibling != f && this.Za.insertBefore(c, f)
},
f: Aa
};
P.b = !0;
...
var c = b.content;
null != c && "" != c && $a.Hn != c && (a.Tn.innerHTML = c, a.Tk.hidden = !1, a.nd.onclick = function() {
$a.Hn = c;
...
var c = null == b ? !1 : b.bb;
this.bk != c && (this.g.className = "room-view" +
(c ? " admin" : ""), this.bk = c);
var d = !c || null != a.K;
this.uf.disabled = d;
this.nf.disabled = d;
...
r.b = !0;
r.Em = function(a) {
if (a instanceof Array && null == a.mb) return Array;
var b = a.f;
if (null != b) return b;
a = r.sj(a);
...
d = "[";
b += "\t";
for (f = 0; f < c;) e = f++, d += (0 < e ? "," : "") + r.Ae(a[e], b);
return d + "]"
}
try {
d = a.toString
...
if (a instanceof b || r.lh(r.Em(a), b)) return !0
} else {
if ("object" == typeof b && r.jn(b) && a instanceof b) return !0
}
else return !1;
...
Ia.Za = ["Afghanistan", "AF", 33.3, 65.1, "Albania", "AL", 41.1, 20.1, "Algeria", "DZ", 28, 1.6, "American Samoa", "AS", -14.2, -170.1, "Andorra", "AD", 42.5, 1.6, "Angola", "AO", -11.2, 17.8, "Anguilla", "AI", 18.2, -63, "Antigua and Barbuda", "AG", 17, -61.7, "Argentina", "AR", -34.5, -58.4, "Armenia",
...
46.9, -56.2, "Saint Vincent", "VC", 12.9, -61.2, "Samoa", "WS", -13.7, -172.1, "San Marino", "SM", 43.9, 12.4, "Saudi Arabia", "SA", 23.8, 45, "Scotland", "SCT", 56.5, 4.2, "Senegal", "SN", 14.4, -14.4, "Serbia", "RS", 44, 21, "Seychelles", "SC", -4.6, 55.4, "Sierra Leone", "SL", 8.4, -11.7, "Singapore", "SG", 1.3, 103.8, "Slovakia", "SK", 48.6, 19.6, "Slovenia", "SI", 46.1, 14.9, "Solomon Islands", "SB", -9.6, 160.1, "Somalia", "SO", 5.1, 46.1, "South Africa", "ZA", -30.5, 22.9, "South Georgia", "GS", -54.4, -36.5, "South Korea", "KR", 35.9, 127.7, "Spain", "ES", 40.4,
-3.7, "Sri Lanka", "LK", 7.8, 80.7, "Sudan", "SD", 12.8, 30.2, "Suriname", "SR", 3.9, -56, "Svalbard and Jan Mayen", "SJ", 77.5, 23.6, "Swaziland", "SZ", -26.5, 31.4, "Sweden", "SE", 60.1, 18.6, "Switzerland", "CH", 46.8, 8.2, "Syria", "SY", 34.8, 38.9, "S\u00e3o Tom\u00e9 and Pr\u00edncipe", "ST", .1, 6.6, "Taiwan", "TW", 23.6, 120.9, "Tajikistan", "TJ", 38.8, 71.2, "Tanzania", "TZ", -6.3, 34.8, "Thailand", "TH", 15.8, 100.9, "Timor-Leste", "TL", -8.8, 125.7, "Togo", "TG", 8.6, .8, "Tokelau", "TK", -8.9, -171.8, "Tonga", "TO", -21.1, -175.1, "Trinidad and Tobago",
"TT", 10.6, -61.2, "Tunisia", "TN", 33.8, 9.5, "Turkey", "TR", 38.9, 35.2, "Turkmenistan", "TM", 38.9, 59.5, "Turks and Caicos Islands", "TC", 21.6, -71.7, "Tuvalu", "TV", -7.1, 177.6, "U.S. Minor Outlying Islands", "UM", 0, 0, "U.S. Virgin Islands", "VI", 18.3, -64.8, "Uganda", "UG", 1.3, 32.2, "Ukraine", "UA", 48.3, 31.1, "United Arab Emirates", "AE", 23.4, 53.8, "United Kingdom", "GB", 55.3, -3.4, "United States", "US", 37, -95.7, "Uruguay", "UY", -32.5, -55.7, "Uzbekistan", "UZ", 41.3, 64.5, "Vanuatu", "VU", -15.3, 166.9, "Vatican City", "VA", 41.9, 12.4, "Venezuela",
"VE", 6.4, -66.5, "Vietnam", "VN", 14, 108.2, "Wallis and Futuna", "WF", -13.7, -177.1, "Western Sahara", "EH", 24.2, -12.8, "Yemen", "YE", 15.5, 48.5, "Zambia", "ZM", -13.1, 27.8, "Zimbabwe", "ZW", -19, 29.1
];
